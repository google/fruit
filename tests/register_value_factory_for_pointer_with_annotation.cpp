// expect-compile-error FactoryReturningPointerError<fruit::Annotated<Annotation1,Scaler\*>(fruit::Assisted<double>)>|The specified factory returns a pointer. This is not supported
/*
