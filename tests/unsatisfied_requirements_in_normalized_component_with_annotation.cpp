// expect-compile-error UnsatisfiedRequirementsInNormalizedComponentError<fruit::Annotated<Annotation,X>>|The requirements in UnsatisfiedRequirements are required by the NormalizedComponent but are not provided by the Component
/*
