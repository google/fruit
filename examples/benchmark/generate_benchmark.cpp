...
int main(int argc, char* argv[]) {
  ...
  vector<string> fruit_srcs = {"component_storage", "demangle_type_name", "fixed_size_allocator", "greedy_allocator_storage", "injector_storage", "normalized_component_storage", "semistatic_map", "semistatic_graph"};
